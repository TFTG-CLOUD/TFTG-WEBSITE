        ...
        <div class="grid grid-cols-12 gap-4 gap-y-8 sm:gap-8 py-8 md:py-12">
          <div class="col-span-12 lg:col-span-4 pr-8">
            ...
            <div class="text-sm text-gray-600 dark:text-gray-400">
              TFTG is a Telegram bot dedicated video cloud transcoding system. Automatically download videos from Telegram bot, transcode them, add watermarks, publish videos to bot, etc.
            </div>
          </div>
