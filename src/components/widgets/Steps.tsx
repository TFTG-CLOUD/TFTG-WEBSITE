...
export default component$(() => {
  const stepsData = {
    title: "Simple steps, perfect functionality.",
    items: [
      {
        title: "Step 1",
        description:
          "Install the open source version or paid subscription version, install via docker, or install via script.",
        icon: IconStar,
      },
      {
        title: "Step 2",
        description:
          "Enter the dashboard, set up the Telegram bot, set transcoding parameters, etc.",
        icon: IconStar,
      },
      {
        title: "Step 3",
        description:
          "Set up a publishing Telegram bot, etc., and let the robot automatically publish the transcoded video to the Telegram group.",
        icon: IconStar,
      },
      {
        title: "Ready!",
